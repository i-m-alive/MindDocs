...
DOMAIN_MODEL_MAP: Dict[str, str] = {
    "medical": "llama3-8b-8192",
    "retail": "llama3-retail",
    "finance": "llama3-finance",
    "legal": "llama3-legal",
    "education": "llama3-edu",
...
def get_llm_by_domain(domain: str, stream=False, handler=None) -> ChatGroq:
    ...
    logger.info(f"➡️ Using Groq model '{model_name}' for domain '{domain}'")
    return ChatGroq(
        model=model_name,
        api_key=api_key,
